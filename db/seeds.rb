...
%w[surfing weightlifting calisthenics yoga swimming dancing].each_with_index do |type, idx|
  ...
  session = CoachSession.new(session_name: "Your #{type} coach in town!", type_of_activity: CoachSession::ACTIVITIES[idx], description: "10 years experience as a coach", price_per_day: 50, user: coach, address: "Java")
...
%w[surfing weightlifting calisthenics yoga swimming dancing].each_with_index do |type, idx|
  ...
  session = CoachSession.new(session_name: "Train with me", type_of_activity: CoachSession::ACTIVITIES[idx], description: "#{type} is fun with me!", price_per_day: 45, user: coach, address: "Denpasar")
