...
%w[surfer weightlifter calis yoga swimmer dancer].each_with_index do |type, idx|
  ...
  4.times do |i|
    ...
    session.additional_photos.attach(io: fsubfile_one, filename: "trainer.jpeg")
  end
  session.save!
  p session
end
...
%w[surfer weightlifter calis yoga swimmer dancer].each_with_index do |type, idx|
  ...
  session.main_photo.attach(io: file, filename: "coachtwo.jpeg")
  4.times do |i|
...
%w[surfer weightlifter calis yoga swimmer dancer].each_with_index do |type, idx|
  ...
  session.main_photo.attach(io: file, filename: "coachthree.jpeg")
  4.times do |i|
...
%w[surfer weightlifter calis yoga swimmer dancer].each_with_index do |type, idx|
  ...
  session.main_photo.attach(io: file, filename: "coachfour.jpeg")
  4.times do |i|
